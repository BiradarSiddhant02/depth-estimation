...
depth_model_0.load_state_dict(torch.load("models/gen-1/0.pth", weights_only=False))

depth_model_1 = Model().to(DEVICE)
depth_model_1.load_state_dict(torch.load("models/gen-1/1.pth", weights_only=False))

depth_model_2 = Model().to(DEVICE)
depth_model_2.load_state_dict(torch.load("models/gen-1/2.pth", weights_only=False))

depth_model_3 = Model().to(DEVICE)
depth_model_3.load_state_dict(torch.load("models/gen-1/3.pth", weights_only=False))
